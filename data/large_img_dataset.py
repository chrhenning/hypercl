...
class LargeImgDataset(Dataset):
    ...
    Attributes (additional to base class):
        ...
        torch_train: An instance of torch.utils.data.Dataset representing the
            training set.
        torch_test: An instance of torch.utils.data.Dataset representing the
            test set.
        torch_val: An instance of torch.utils.data.Dataset representing the
            validation set.
    """
    ...
    def torch_train(self):
        """Getter for read-only attribute torch_train."""
    ...
    @property
    def torch_test(self):
        """Getter for read-only attribute torch_test."""
    ...
    @property
    def torch_val(self):
        """Getter for read-only attribute torch_val."""
